...
package ru.sber.platformv.faas.invoker.http;
    ...
    public void multiPartRequest() throws Exception {
        ...
        HttpRequestTest test =
            request -> {
                ...
                HttpRequest.HttpPart textPart = request.getParts().get("text");
                ...
                HttpRequest.HttpPart bytesPart = request.getParts().get("binary");
