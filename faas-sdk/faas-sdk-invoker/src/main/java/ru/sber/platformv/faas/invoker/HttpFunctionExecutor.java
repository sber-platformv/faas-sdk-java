...
import ru.sber.platformv.faas.invoker.http.HttpRequestImpl;
import ru.sber.platformv.faas.invoker.http.HttpResponseImpl;
...
public class HttpFunctionExecutor extends HttpServlet {
    private static final Logger logger = Logger.getLogger("ru.sber.platformv.faas.invoker");
